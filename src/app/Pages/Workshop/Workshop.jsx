    ...
    return (
        <div className="relative bg-[#f4f1ea] text-white">
            <div className="sticky top-0 h-screen overflow-hidden ">
                <div
                    className="absolute left-0 top-[15%] whitespace-nowrap text-[10vw] font-bold leading-none tracking-tighter text-black"
                    style={{ transform: `translate3d(${-scrollPosition * 0.5}px, 0, 0)` }}
                >
                    REGISTER NOW / REGISTER NOW / REGISTER NOW
                </div>
                <div
                    className="absolute left-0 top-[45%] -translate-y-1/2 whitespace-nowrap text-[9.5vw] font-bold leading-none tracking-tighter text-neutral-500"
