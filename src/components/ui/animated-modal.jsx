      ...
      {open && (
        <motion.div
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "max-w-[70vw] min-h-[70vh] bg-[rgb(6,136,184)] text-black border border-transparent dark:border-neutral-800 md:rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden",
              className
            )}
            initial={{
              opacity: 0,
