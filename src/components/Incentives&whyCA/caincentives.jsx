              ...
              {incentives.map((incentive, index) => (
                ...
                >
                  ...
                  <div className="relative flex items-start gap-6 p-6">
                    ...
                    <div className={`relative rounded-xl p-[1px] bg-gradient-to-br ${incentive.gradient}`}>
                      <div className="bg-black rounded-xl p-3 backdrop-blur-xl group-hover:scale-110 transition-transform duration-500">
